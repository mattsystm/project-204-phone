...
locals {
  github-repo     = "https://github.com/mattsystm/project-204-phonebook.git"
  github-file-url = "https://raw.githubusercontent.com/mattsystm/project-204-phonebook/master/"
}
...
resource "aws_ecr_repository" "ecr-repo" {
  name                 = "matt-clarusway-repo/phonebook-app"
...
resource "aws_instance" "docker-machine-leader-manager" {
  ...
  security_groups      = ["matt-docker-swarm-sec-gr"]
...
resource "aws_instance" "docker-machine-managers" {
  ...
  tags = {
    Name = "Matt-Docker-Swarm-Manager-${count.index + 1}"
  }
...
resource "aws_instance" "docker-machine-workers" {
  ...
  tags = {
    Name = "Matt-Docker-Swarm-Worker-${count.index + 1}"
  }
  depends_on = [aws_instance.docker-machine-leader-manager]
}
variable "sg-ports" {
